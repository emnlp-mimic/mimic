...
class Line(base.Recall):

    def __init__(self,
                 input_size: int = 96,
                 hidden_size: int = 64,
                 output_size: int = 1042,
                 lr: float = 1e-4,
                 **kwargs: Any) -> None:
        super().__init__()
        self.lr = lr
    ...
    def add_model_specific_args(parent_parser):
        ...
        parser.add_argument('--input_size', type=int, default=97)
        parser.add_argument('--hidden_size', type=int, default=64)
        parser.add_argument('--lr', type=float, default=1e-4)
        return parser


class Lstm(base.Recall):
    ...
    def forward(self, x):
        output = self.enc(x[0])
        return torch.softmax(self.pred(output), dim=-1).squeeze(1)

    @staticmethod
    def add_model_specific_args(parent_parser):
        parser = ArgumentParser(parents=[parent_parser], add_help=False)
        parser.add_argument('--input_size', type=int, default=7508)
...
class Star(base.Recall):
    ...
    def add_model_specific_args(parent_parser):
        parser = ArgumentParser(parents=[parent_parser], add_help=False)
        parser.add_argument('--input_size', type=int, default=7411)
...
class MBertLstm(base.BertRecall):
    def __init__(self,
                 pretrained_bert_dir: str = '',
    ...
    def forward(self, x):
        ...
        return torch.softmax(self.pred(fusion), dim=-1).squeeze(1)
    ...
    def add_model_specific_args(parent_parser):
        ...
        parser.add_argument('--ts_input_size', type=int, default=7411)
...
class MLstmBert(base.BertRecall):
    def __init__(self,
                 pretrained_bert_dir: str = '',
                 ti_input_size: int = 96,
                 ti_norm_size: int = 64,
...
class MBertStar(base.BertRecall):
    def __init__(self,
                 pretrained_bert_dir: str = '',
                 ti_input_size: int = 96,
                 ti_norm_size: int = 64,
...
class MStarBert(base.BertRecall):
    def __init__(self,
                 pretrained_bert_dir: str = '',
                 ti_input_size: int = 96,
                 ti_norm_size: int = 64,
...
class MBertEncoder(base.BertRecall):
    def __init__(self,
                 pretrained_bert_dir: str = '',
                 ti_input_size: int = 96,
                 ti_norm_size: int = 64,
...
class MEncoderBert(base.BertRecall):
    def __init__(self,
                 pretrained_bert_dir: str = '',
                 ti_input_size: int = 96,
                 ti_norm_size: int = 64,
    ...
    def add_model_specific_args(parent_parser):
        ...
        parser.add_argument('--ti_norm_size', type=int, default=64)
        parser.add_argument('--ts_input_size', type=int, default=7411)
        parser.add_argument('--ts_norm_size', type=int, default=128)
...
class MBertCnn(base.BertRecall):
    def __init__(self,
                 pretrained_bert_dir: str = '',
                 ti_input_size: int = 96,
                 ti_norm_size: int = 64,
...
class EncoderBertAttn(base.BertRecall):
    def __init__(self,
                 pretrained_bert_dir: str = '',
                 ts_input_size: int = 4816,
                 ts_norm_size: int = 1024,
    ...
    def add_model_specific_args(parent_parser):
        parser = ArgumentParser(parents=[parent_parser], add_help=False)
        parser.add_argument('--ts_input_size', type=int, default=7508)
        parser.add_argument('--ts_norm_size', type=int, default=768)
...
class BertEncoderAttn(base.BertRecall):
    def __init__(self,
                 pretrained_bert_dir: str = '',
                 ts_input_size: int = 4816,
                 ts_norm_size: int = 1024,
...
class BertEncoderOuter(base.BertRecall):
    def __init__(self,
                 pretrained_bert_dir: str = '',
                 ts_input_size: int = 4816,
                 ts_norm_size: int = 1024,
        ...
        self.outer = base.Outer(inp1_size=bert_size, inp2_size=ts_norm_size, n_neurons=ts_norm_size)
